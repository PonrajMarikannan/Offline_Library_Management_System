...
if(isset($_POST["register_button"]))
{
	...
	if($message == '')
	{
		...
		else
		{
			...
			$mail->Username = 'jpkavishka@gmail.com';  //Here you can use your Gmail Email Address

			$mail->Password = 'uhlfsxpucoarxkex';  //Here you can use your Gmail Address Password
			...
			$mail->Body = '
			 <p>Thank you for registering for Library Management System Demo & your Unique ID is <b>'.$user_unique_id.'</b> which will be used for issue book.</p>
                ...
                <p><a href="http://localhost:3000/library_management_system/verify.php?code='.$user_verificaton_code.'">Click to Verify</a></p>
                <p>Thank you...</p>
			';
...
<div class="d-flex align-items-center justify-content-center mt-5 mb-2">
	<div class="col-md-6">
		...
		?>
		  ...
		  <style>
	body {
    background-image: url('https://images.unsplash.com/photo-1549675584-91f19337af3d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1172&q=80');
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-1">
                ...
                <input type="text" name="user_email_address" id="user_email_address" class="form-control form-control-sm" />
            </div>
        </div>
        <div class="col-sm-6">
            <div class="mb-1">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-1">
                ...
                <input type="text" name="user_name" class="form-control form-control-sm" id="user_name" value="" />
            </div>
        </div>
        <div class="col-sm-6">
            <div class="mb-1">
                <label class="form-label">User Contact No.</label>
                <input type="text" name="user_contact_no" id="user_contact_no" class="form-control form-control-sm" />
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
            <div class="mb-1">
                ...
                <textarea name="user_address" id="user_address" class="form-control form-control-sm"></textarea>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="mb-1">
