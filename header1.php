...
<div id="layoutSidenav">
    ...
    .navbar ul {
        ...
        padding: 0;
        list-style: none;
        margin-right: 100px; /* Adjust the desired margin value */
    			...
    			<header class="pb-3 mb-4 border-bottom">
                    <div class="row">
        				<div class="col-md-6">
                            ...
                            <span class="fs-4" style="font-size: 24px; color: white; font-weight: bold;">LIBRARY MANAGEMENT SYSTEM</span>
                            </a>
                        </div>
                        <div class="col-md-6">
                            <?php 
                                ...
                                <nav class="navbar navbar-dark bg-dark container-fluid">
                                    <ul class="mt-2">
                                        <li class="list-inline-item">
                                            <a style="font-size: 18px; font-weight: bold;" href="contact.php">CONTACT</a>
                                        </li>
                                    </ul>
                                    <ul class="mt-2">
                                        <li class="list-inline-item">
                                        <a style="font-size: 18px; font-weight: bold;" href="about.html">ABOUT</a>
                                        </li>
                                    </ul>
                            </nav>
                                <?php 
