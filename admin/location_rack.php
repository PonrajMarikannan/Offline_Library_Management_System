...
<div class="container-fluid py-4" style="min-height: 700px;">
    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="card mb-4">
    			<div class="card-header">
				<h3 style="font-size: 24px; color: black; font-weight: bold;">EDIT RACK LOCATION</h3>
                </div>
                <div class="card-body">
                	<form method="post">
                		<div class="mb-3">
	...
	<div class="card mb-4">
		<div class="card-header">
			<div class="row">
				...
				<h3 style="font-size: 24px; color: black; font-weight: bold;">RACK LOCATION MANAGEMENT</h3>
				</div>
