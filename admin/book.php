...
<div class="container-fluid py-4" style="min-height: 700px;">
    ...
    <div class="card mb-4">
		...
		<h3 style="font-size: 24px; color: black; font-weight: bold;">ADD NEW BOOK</h3>
        </div>
        <div class="card-body">
        	<form method="post">
        		<div class="row">
    ...
    <div class="card mb-4">
    	<div class="card-header">
		<h3 style="font-size: 24px; color: black; font-weight: bold;">EDIT BOOK DETAILS</h3>
       	</div>
       	<div class="card-body">
       		<form method="post">
       			<div class="row">
	...
	<div class="card mb-4">
		<div class="card-header">
			<div class="row">
				...
				<h3 style="font-size: 24px; color: black; font-weight: bold;">BOOK MANAGEMENT</h3>
                </div>
