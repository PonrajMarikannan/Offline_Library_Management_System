...
<style>
        body
        {
            background-image: url('https://t4.ftcdn.net/jpg/01/62/68/21/360_F_162682117_szCd1KqcSF7xHJGQEDVcBnKB3Z0T8X9r.jpg');
...
<div class="container-fluid py-4" style="min-height: 700px;">
	<h1 style="font-weight: bold;">BOOK ISSUED DETAILS</h1>
	<div class="card mb-4">
		<div class="card-header">
			<div class="row">
				<div class="col col-md-6">
				<h1 style="font-size: 18px;font-weight:bold">BOOK ISSUED DETAILS</h1>
				</div>
